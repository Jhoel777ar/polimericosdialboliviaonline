...
<template>
    ...
    <AuthenticationCard>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            Antes de continuar, ¿podría verificar su dirección de correo electrónico haciendo clic en el enlace que acabamos de enviarle? Si no ha recibido el correo electrónico, estaremos encantados de enviarle otro.
        </div>
